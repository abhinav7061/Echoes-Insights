  ...
  return (
    ...
    >
      ...
      <span ref={actions} className="relative">
        <button
          className="flex items-center justify-center bg-gray-200 hover:bg-gray-400 w-8 h-8 rounded-full overflow-hidden"
          onClick={() => {
            setOpen((open) => !open);
        ...
        {open && (
          <div className="absolute top-10 right-0 bg-neutral-100 dark:border border-neutral-700 dark:bg-neutral-800 shadow-lg shadow-neutral-800 rounded-md p-4">
            <div
