...
import { LineChart, PieChart, BarChart, RadarChart, PolarAreaChart } from '../../../components/Charts';
        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl shadow-sm p-6">
                    <LineChart data={viewsData} options={viewsOptions} />
                </div>
                <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl shadow-sm p-6">
                    <BarChart data={contentPerformanceData} options={{
                        ...
                        maintainAspectRatio: false,
                        plugins: {
                            title: { display: true, text: 'Top Content' },
                            legend: { position: 'top' }
                        }
                    }} />
                </div>
                <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl shadow-sm p-6">
                    <RadarChart data={audienceData} options={{
                        plugins: {
                            title: { display: true, text: 'Audience Age' }
                        }
                    }} />
                </div>
                <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl shadow-sm p-6">
